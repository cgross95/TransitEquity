...
all_ja <- all_ja %>% 
  ...
  pivot_longer(c("transit", "red_line", "difference"), 
...
Now we will join the job accessibility with the computed socioeconomic index. We also tag those FIPS that have below-mean indices.
...
all_ja <- svi %>% left_join(all_ja, by = "FIPS") %>% 
